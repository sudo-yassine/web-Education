...
<body>
    ...
    <div class="container">
        ...
        <center>        
        <img src="reclamation.png" alt="reclamation.png">
        </center>

        <!-- Modal -->
        <table></table>
        <div class="modal fade" id="addreclamationsModal" tabindex="-1" aria-labelledby="addreclamationsModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id_reclamation="addreclamationsModalLabel"></h5>
                    </div>
                    <div class="modal-body">
                        <form method="POST" id="insertForm" action="Addreclamations.php" enctype="multipart/form-data">
                        <label class="br_submission"> Submit your reclamations here: </label>
                        <style> 
                        .br_submission {
