...
<head>
    ...
    <link rel="stylesheet" href="./css/style.css">
   		<link rel="stylesheet" href="./resources/css/frontexam.css" />
                        ...
                        <form method="POST" id="insertForm" action="addexamen.php" enctype="multipart/form-data">
                            <div class="row mb-3">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text"class="form-control"  name="titre" placeholder="nom du examen" onblur="validateName(this)" value="<?php echo htmlspecialchars($examen['titre'] ?? ''); ?>">  

                                    <div id="erreur" class="text-danger"></div>
                                </div>
                                <div class="col">
                                    <label class="form-label" >description</label>
                                    <input type="text" class="form-control" name="description" placeholder="nombre description"onblur="validateduree(this)"value="<?php echo htmlspecialchars($examen['description'] ?? ''); ?>">
                                    <div id="erreur" class="text-danger"></div>
                                </div>
                                <div>
                                    <label >duree</label>
                                    <input type="text" class="form-control" name="duree" placeholder="duree" onblur="validateduree(this)"value="<?php echo htmlspecialchars($examen['duree'] ?? ''); ?>">
                                    <div id="erreur" class="text-danger"></div>
                                </div>
...
;
    ...
    <?php foreach ($list as $examen) { ?>
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?= $examen['titre']; ?></h5>
                    <p class="card-text">description: <?= $examen['description']; ?></p>
                    <p class="card-text">duree: <?= $examen['duree']; ?></p>
                    <p class="card-text">difficulte: <?= $examen['difficulte']; ?></p>
                    <p class="card-text">date_heure: <?= $examen['date_heure']; ?></p>
