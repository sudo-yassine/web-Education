...
<html lang="en">
	...
	<body>
		...
		<div class="container mt-4">
			<div class="row">
				<?php // Associative array mapping subject IDs to logo file names 
        $subjectLogos = array( 2 =>
				'https://img.freepik.com/premium-vector/calculator-icon-vector-design-templates_1172029-3367.jpg', 3 =>
				'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS4FRrhI0Cg69MEC53yw1Q7X5oEyqR8apZY1Pf-r4AVZA&s', 4 =>
				'https://media.istockphoto.com/id/1225713087/vector/computer-monitor-with-keyboard-and-mouse-line-icon-smart-home-symbol-technology-vector-sign.jpg?s=612x612&w=0&k=20&c=VhIyfzh9PRk-La9NaeejH1IN2TqQKMDr3wuj0pG8e2U=',
				5=> 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuMX_c2_VtGwbvewFuyH66HiPqlncKyU59xtKtR3FLPA&s' ); foreach ($matieres as $matiere) { ?>
				<div class="col-md-3">
					<div class="card subject-card" onclick="submitForm(<?= $matiere['id_matiere'] ?>)">
						<img
							src="<?= $subjectLogos[$matiere['id_matiere']] ?>"
							class="card-img-top subject-logo"
							alt="Subject Logo"
						/>
					...
					<div class="quiz">
						<button
							type="button"
							class="btn btn-primary pop-quiz-btn"
							onclick="displayQuiz(<?= $matiere['id_matiere'] ?>)"
						>
							Pop Quiz
						</button>
					</div>
			...
			<div class="col-md-12 text-md-right">
				<!-- Use text-md-right class to align content to the right on medium screens and larger -->
						...
						<div class="card course-card">
							<div class="card-body">
								...
								<div class="d-flex justify-content-between align-items-center">
									...
									<button class="btn btn-primary rounded-pill" onclick="toggleInfo('<?= $cours['id_cours'] ?>')">
										More Info
									</button>
