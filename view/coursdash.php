...
;
    ...
    <thead class="table-dark">
        <tr>
            ...
            <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nom Cours</th>
    ...
    <tbody>
        ...
        ?>
            <tr>
                ...
                <td class="align-middle">
                    <a href="deletecours.php?id_cours=<?php echo $cours['id_cours']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete">
                        Delete
                    </a>
                </td>
            </tr>
