  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3 mt-5" >
            <div class="text-body-secondary">
                <span class="h5">tous les admin</span>
                <br>
               crud admin 
            </div>
        ...
        <div class="modal fade"  id="addcoursModal" tabindex="-1" aria-labelledby="addcoursModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form method="POST" id="insertForm" action="addadminback.php" enctype="multipart/form-data" onsubmit="return validateForm();">
                        <div class="row mb-3">
                            <div class="col">
    ...
    <?php foreach ($list as $admin) { ?>
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?= $admin['niveau']; ?></h5>
                    <p class="card-text">nom: <?= $admin['nom']; ?></p>
                    <p class="card-text">prenom: <?= $admin['prenom']; ?></p>
                </div>
            </div>
        </div>
    <?php } ?>
              ...
              <table class="table align-middle" id="myTable" style="width:100%;">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">pass</th>
    ...
    foreach ($list as $admin) {
        ?>
            <tr>
                ...
                <td><?= $admin['Email']; ?></td>
                <td>
                    <a href="updateadminback.php?Id_admin=<?php echo $admin['Id_admin']; ?>" class="btn"><i class="fa-solid fa-pen-to-square fa-xl"></i>Modifier</a>
                </td>
                <td>
                    <a href="deleteadminback.php?Id_admin=<?php echo $admin['Id_admin']; ?>"class="btn"><i class="fa-solid fa-trash fa-xl"></i>supprimer</a>
                </td>
