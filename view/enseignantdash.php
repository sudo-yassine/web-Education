  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3 mt-5" >
            <div class="text-body-secondary">
                <span class="h5">tous les enseignant</span>
                <br>
               crud enseignant 
            </div>
        </div>
        ...
        <script>
                        ...
                        function validatespecialite(input) {
                            var name = input.value.trim();
                            var errorDiv = input.nextElementSibling;
                            var regex=/^[a-zA-Z0-9]+$/;
                            if (!regex.test(name)) {
    ...
    <?php foreach ($list as $enseignant) { ?>
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?= $enseignant['Nom']; ?></h5>
                    <p class="card-text">Prenom: <?= $enseignant['Prenom']; ?></p>
                    <p class="card-text">Email: <?= $enseignant['Email']; ?></p>
                    <p class="card-text">Tel: <?= $enseignant['Tel']; ?></p>
                </div>
            </div>
        </div>
    <?php } ?>
              ...
              <table class="table align-middle" id="myTable" style="width:100%;">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Tél</th>
                            ...
                            <tbody>
                                ...
                                foreach ($list as $enseignant) {
                                    ...
                                    echo '<td class="align-middle"><a href="updateenseignantback.php?Id_enseignant=' . escape($enseignant['Id_enseignant']) . '" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Modifier">Modifier</a></td>';
                                    echo '<td class="align-middle"><a href="deleteelevback.php?Id_enseignant=' . escape($enseignant['Id_enseignant']) . '" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Supprimer">Supprimer</a></td>';
                                    echo '</tr>';
                                }
                                ?>
                            </tbody>
