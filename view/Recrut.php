  ...
  <body>
    ...
    <header class="header-outer">
      <div class="header-inner responsive-wrapper">
        ...
        <a href="joinus.html">
          <button href="joinus.html">Join Us</button>
        </a>
      </div>
    </header>
    <body>
...
<body>
    ...
    <div class="container">
        ...
        <center>        
        <img src="recrut.png" alt="recrut.png">
        </center>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id_recrutement="addRecrutModalLabel"></h5>                    </div>
                    <div class="modal-body">
                        <form method="POST" id="insertForm" action="Recrut.php" enctype="multipart/form-data">
                        <label class="br_submission"> Submit your informations here: </label>
                        <style> 
                        .br_submission {
                        font-size: 45; /* Adjust the font size as needed */
                        color: #5865f2;; /* Change the color to your preference */
                        ...
                        <table> 
                            ...
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="date" class="form-control" name="date_entretien" placeholder="DD/MM/YYYY">
                        ...
                        <table> 
                                <div class="col">
                                    <label class="form-label">Why Should WisdomWave Recruit you?</label>
                                    <input type="text" class="form-control" name="reponse" placeholder="answer here">
