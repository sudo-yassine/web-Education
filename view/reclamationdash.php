...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
        <div class="text-body-secondary">
            <span class="h5">Recruts table</span>
            <br>
            Manage all your existing recruts or add a new one
        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addRecrutModalLabel">Ajout recrut</h5>
                    ...
                    <form method="POST" id="insertForm" action="AddRecrut.php" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="date" class="form-control" name="date_entretien" placeholder="YYYY-MM-DD">
                            </div>
                            <div class="col">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="reponse" placeholder="Répondre ici" onblur="validateReponse(this)">
                ...
                <?php foreach ($list as $reclamation) { ?>
                    <tr>
                        ...
                        <td class="text-center">
                            <a href="Updatereclamation.php?id_reclamation=<?= $reclamation['id_reclamation']; ?>">Update</a>
                            <a href="Deletereclamation.php?id_reclamation=<?= $reclamation['id_reclamation']; ?>">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
