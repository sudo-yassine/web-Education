...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100 h-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="coursdash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="utilisateurdash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="examendash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1"> examen</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  active" href="ressourcesdash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="recrutdash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1"> recrutement</span>
          </a>
        </li>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="panierdash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="elevedash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">eleve</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link  active" href="enseignantdash.php">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>office</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                    ...
                    <form method="POST" id="insertForm" action="addexamen.php" enctype="multipart/form-data">
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" name="titre" placeholder="Titre" onblur="validateTitre(this)" value="<?php echo htmlspecialchars($admin['titre'] ?? ''); ?>">
                                <div id="error_nom" class="text-danger"></div>
                            </div>
                            <div class="col">
                                <label class="form-label">Description</label>
                                <input type="text" class="form-control" name="description" placeholder="Description" onblur="validateDescription(this)" value="<?php echo htmlspecialchars($admin['description'] ?? ''); ?>">
                    ...
                    <script>
                        ...
                        function validateDescription(input) {
                            ...
                            if (!regex.test(descrip)) {
                                errorDiv.textContent = "Veuillez entrer une description valide ";
                                return false;
                            } else {
                                errorDiv.textContent = "";
                                return true;
            ...
            <div class="col">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-text">Durée: <?= $examen['duree']; ?></p>
                        <p class="card-text">Difficulté: <?= $examen['difficulte']; ?></p>
                        <p class="card-text">Date et heure d'ajout: <?= $examen['date_heure']; ?></p>
                        <a href="updateexamen.php?id_examen=<?= $examen['id_examen']; ?>" class="btn btn-primary"><i class="fa-solid fa-pen-to-square fa-lg"></i> Update</a>
                        <a href="deleteexamen.php?id_examen=<?= $examen['id_examen']; ?>" class="btn btn-danger"><i class="fa-solid fa-trash fa-lg"></i> Delete</a>
                    </div>
                </div>
            </div>
        <?php } ?>
    ...
    <div class="row">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    <a href="examendash.php?order=ASC" class="btn btn-primary">Trier par difficulté croissante</a>
                    <a href="examendash.php?order=DESC" class="btn btn-primary">Trier par difficulté décroissante</a>
                </div>
                <h6 class="text-body-secondary">Exams table</h6>
            </div>
            <div class="card mb-4">
                        ...
                        <table class="table align-middle" id="myTable" style="width:100%;">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Difficulté</th>
