        ...
        <table class="table table-bordered table-striped table-hover align-middle" id="myTable">
            ...
            <tbody>
                ...
                foreach ($list as $eleve) {
                    ...
                    echo '<td><a href="updateEleve.php?Id_eleve=' . escape($eleve['Id_eleve']) . '" class="btn btn-success"><i class="fa-solid fa-pen-to-square"></i> Modifier</a></td>';
                    echo '<td><a href="DeleteEleve.php?Id_eleve=' . escape($eleve['Id_eleve']) . '" class="btn btn-danger"><i class="fa-solid fa-trash"></i> Supprimer</a></td>';
                    echo '</tr>';
                }
                ?>
            </tbody>
