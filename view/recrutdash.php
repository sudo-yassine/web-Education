...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="d-flex justify-content-between align-items-center mb-3 mt-5">
        ...
        <!-- Button to trigger Add Recrutement modal -->
    ...
    <div class="row">
        <?php foreach ($list as $Recrut) { ?>
            <div class="col-md-4 mb-4">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Date Entretien: <?= $Recrut['date_entretien']; ?></h5>
                        <p class="card-text">CV: <?= $Recrut['cv']; ?></p>
                        <p class="card-text">Reponse: <?= $Recrut['reponse']; ?></p>
                        <div class="text-center">
                            <a href="UpdateRecrut.php?id_recrutement=<?= $Recrut['id_recrutement']; ?>" class="btn btn-primary">Update</a>
                            <a href="DeleteRecrut.php?id_recrutement=<?= $Recrut['id_recrutement']; ?>" class="btn btn-danger">Delete</a>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <table class="table align-middle" id="myTable" style="width:100%;">
                            <thead class="table-dark">
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Date Entretien</th>
                                ...
                                <?php foreach ($list as $Recrut) { ?>
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="UpdateRecrut.php?id_recrutement=<?= $Recrut['id_recrutement']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Update">
                                                Update
                                            </a>
                                        </td>
                                        <td class="align-middle">
                                            <a href="DeleteRecrut.php?id_recrutement=<?= $Recrut['id_recrutement']; ?>" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Delete">
                                                Delete
                                            </a>
                                        </td>
                                    </tr>
