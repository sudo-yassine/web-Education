...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3 mt-5" >
            ...
            <div class="modal-header d-flex justify-content-between align-items-center">
                ...
                <a href="addeleveformback.php" class="btn btn-primary">Ajouter un élève</a>
            </div>
            <div class="modal-header d-flex justify-content-between align-items-center">
                <h5 id="addcoursModalLabel"></h5>
                <a href="addenseignantformback.php" class="btn btn-primary">Ajouter un enseignant</a>
            </div>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" id="insertForm" action="addutilisateurback.php" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
    ...
    <?php foreach ($list as $utilisateur) { ?>
        <div class="col">
            <div class="card">
                <div class="card-body">
    ...
    foreach ($list as $utilisateur) {
        ?>
            <tr>
                ...
                <td>
                    <a href="updateutilisateurback.php?Id_utilisateur=<?php echo $utilisateur['Id_utilisateur']; ?>" class="btn"><i class="fa-solid fa-pen-to-square fa-xl"></i>Modifier</a>
                </td>
                <td>
                    <a href="deleteutilisateurback.php?Id_utilisateur=<?php echo $utilisateur['Id_utilisateur']; ?>"class="btn"><i class="fa-solid fa-trash fa-xl"></i>supprimer</a>
                </td>
