...
$list = $enseignantC->listenseignants();
?>
<!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 id="addcoursModalLabel">ajouter un enseignant</h5>
                        ...
                        <form method="POST" id="insertForm" action="" enctype="multipart/form-data">
                            <div class="row mb-3">
                                <div class="col">
                                    ...
                                    <input type="text"class="form-control"  name="Nom" placeholder="nom de l'enseignant">
                                </div>
                                <div class="col">
                                    <label class="form-label" >Prenom</label>
                                    <input type="text" class="form-control" name="Prenom" placeholder="Prenom de l'enseignant">
                                </div>
                                <div>
                                    <label >Adresse</label>
