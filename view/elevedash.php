...
$eleveC = new eleveC();
$list = $eleveC->listEleves(); // Assurez-vous que cette fonction renvoie les données correctement
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 mt-1 border-radius-lg ">
    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3 mt-5" >
            <div class="text-body-secondary">
                <span class="h5">tous les eleve</span>
                <br>
               crud eleve 
            </div>
        </div>
    ...
    <?php foreach ($list as $eleve) { ?>
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?= $eleve['Nom']; ?></h5>
                    <p class="card-text">Prenom: <?= $eleve['Prenom']; ?></p>
                    <p class="card-text">Email: <?= $eleve['Email']; ?></p>
                    <p class="card-text">Tel: <?= $eleve['Tel']; ?></p>
                </div>
            </div>
        </div>
    <?php } ?>
              ...
              <table class="table align-middle" id="myTable" style="width:100%;">
                            ...
                            <tbody>
                                ...
                                foreach ($list as $eleve) {
                                    ...
                                    echo '<td class="align-middle"><a href="updateeleveback.php?Id_eleve=' . escape($eleve['Id_eleve']) . '" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Modifier">Modifier</a></td>';
                                    echo '<td class="align-middle"><a href="deleteelevback.php?Id_eleve=' . escape($eleve['Id_eleve']) . '" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Supprimer">Supprimer</a></td>';
                                    echo '</tr>';
                                }
                                ?>
                            </tbody>
